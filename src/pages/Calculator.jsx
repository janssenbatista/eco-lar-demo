      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="flex items-center justify-center mb-6">
            <TreeDeciduous className="text-emerald-600 mr-3" size={40} />
          ...
          <div className="space-y-6">
            ...
            <Button onClick={calculateTrees} className="w-full">
              <Leaf size={20} />
              ...
              <div className="text-center">
                <div className="mb-4">
                  ...
                  <p className="text-xl text-gray-700">
                    {trees === 1 ? "árvore" : "árvores"}
                  </p>
                </div>

                <div className="mt-6 pt-6 border-t border-green-200">
                  <p className="text-sm text-gray-600">
                    💡 <span className="font-semibold">Informação:</span> Uma
                    árvore adulta absorve em média 22 kg de CO₂ por ano
                  </p>
                </div>
              </div>
            </div>
